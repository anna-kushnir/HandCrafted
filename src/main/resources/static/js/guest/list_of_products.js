...
function applyFilters() {
    ...
    const requestURL = `/products?sortByCost=${sortByCost}&sortByCostAsc=${sortByCostAsc}&sortByNewness=${sortByNewness}&sortByNewnessAsc=${sortByNewnessAsc}&priceFrom=${priceFrom}&priceTo=${priceTo}`;
